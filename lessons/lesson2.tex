...
Стохастически эквивалентные означает, что если зафиксировать момент времени $t$, то в этот момент
$P \left\{ \xi \left( t \right) =
...
Реализация такого процесса выглядит как парабола (рис. \ref{fig:218})
с вершиной в точке с координатами
$$t_0 = -\frac{ \eta }{2}, \,
  \zeta_0 = t_0^2 + \eta t_0 + \xi = \frac{ \eta^2}{4} - \frac{ \eta^2}{2}  + \xi =
  \xi - \frac{ \eta^2}{4}$$
